...
**data:** I included data at the short-citcuit, open-circuit and max-power voltages to avoid making the repo to large. To fully recreate the data, the scripts in scripts/data_creation can be used to simulate the same problem.  
...
*plot:* Scripts in scripts/plotting will save plots here.
*scripts:* The main location of my scripts to simulate, organize and analyze data. Contains three main directories:
