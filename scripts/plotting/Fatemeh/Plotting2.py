...
IB_nr_recomb_diagram(spatial0, IB_mask0)
plt.title("Non-radiative Recombination at mpp, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial1, IB_mask1)
plt.title("Non-radiative Recombination at mpp, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial2, IB_mask2)
plt.title("Non-radiative Recombination at mpp, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial3, IB_mask3)
plt.title("Non-radiative Recombination at mpp, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial4, IB_mask4)
plt.title("Non-radiative Recombination at mpp, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial5, IB_mask5)
plt.title("Non-radiative Recombination at mpp, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial6, IB_mask6)
plt.title("Non-radiative Recombination at mpp, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial7, IB_mask7)
plt.title("Non-radiative Recombination at mpp, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial8, IB_mask8)
plt.title("Non-radiative Recombination at mpp, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial9, IB_mask9)
plt.title("Non-radiative Recombination at mpp, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial10, IB_mask10)
plt.title("Non-radiative Recombination at mpp, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial11, IB_mask11)
plt.title("Non-radiative Recombination at mpp, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial12, IB_mask12)
plt.title("Non-radiative Recombination at mpp, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial13, IB_mask13)
plt.title("Non-radiative Recombination at mpp, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial14, IB_mask14)
plt.title("Non-radiative Recombination at mpp, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial15, IB_mask15)
plt.title("Non-radiative Recombination at mpp, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("MPP_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()
...
IB_nr_recomb_diagram(spatial0, IB_mask0)
plt.title("Non-radiative Recombination at SC, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial1, IB_mask1)
plt.title("Non-radiative Recombination at SC, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial2, IB_mask2)
plt.title("Non-radiative Recombination at SC, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial3, IB_mask3)
plt.title("Non-radiative Recombination at SC, GCM=0, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=0__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial4, IB_mask4)
plt.title("Non-radiative Recombination at SC, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial5, IB_mask5)
plt.title("Non-radiative Recombination at SC, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial6, IB_mask6)
plt.title("Non-radiative Recombination at SC, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial7, IB_mask7)
plt.title("Non-radiative Recombination at SC, GCM=10, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=10__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial8, IB_mask8)
plt.title("Non-radiative Recombination at SC, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial9, IB_mask9)
plt.title("Non-radiative Recombination at SC, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial10, IB_mask10)
plt.title("Non-radiative Recombination at SC, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial11, IB_mask11)
plt.title("Non-radiative Recombination at SC, GCM=25, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=25__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()

IB_nr_recomb_diagram(spatial12, IB_mask12)
plt.title("Non-radiative Recombination at SC, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 0.001")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=0.001.png")
plt.clf()

IB_nr_recomb_diagram(spatial13, IB_mask13)
plt.title("Non-radiative Recombination at SC, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 1")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=1.png")
plt.clf()

IB_nr_recomb_diagram(spatial14, IB_mask14)
plt.title("Non-radiative Recombination at SC, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 30")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=30.png")
plt.clf()

IB_nr_recomb_diagram(spatial15, IB_mask15)
plt.title("Non-radiative Recombination at SC, GCM=50, $\sigma_{ci}$=5*$\sigma_{iv}$, $\mu_I$ = 100")
plt.tight_layout()
plt.savefig("SC_nrRecomb_GCM=50__sigmaCI=5sigmaIV_mu=100.png")
plt.clf()
